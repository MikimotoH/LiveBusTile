...
{
    public class WP8PullToRefreshDetector
    {
        ListBox listbox;
        ...
        void listbox_ManipulationCompleted(object sender, System.Windows.Input.ManipulationCompletedEventArgs e)
        {
            AppLogger.Debug("listbox_ManipulationCompleted");
        }

        void listbox_ManipulationDelta(object sender, System.Windows.Input.ManipulationDeltaEventArgs e)
        {
            AppLogger.Debug("listbox_ManipulationDelta");
        }

        void listbox_ManipulationStarted(object sender, System.Windows.Input.ManipulationStartedEventArgs e)
        {
            AppLogger.Debug("listbox_ManipulationStarted");
        }
